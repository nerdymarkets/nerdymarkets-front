  ...
  return (
    <div className="bg-customBlack rounded-3xl py-4 text-white mx-auto shadow-lg border-gray-600 ">
      <table className="w-full ">
        <thead>
          <tr>
            <th className="py-3 px-4 text-left border-b-2 border-black  text-xl sm:text-2xl lg:text-3xl">
              Month/Date
            </th>
            <th className="py-3 px-4 text-center border-b-2 border-black  text-xl sm:text-2xl lg:text-3xl">
              Commentary/Update
            </th>
          </tr>
        </thead>
